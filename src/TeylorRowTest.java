...
class TeylorRowTest {
    ...
    void calcCos() {
        TeylorRow h = new TeylorRow();
        Assertions.assertTrue(Math.abs(Math.cos(Math.toRadians(50)) - TeylorRow.calcCos(16, Math.toRadians(50))) < Math.pow(10, -14));
        Assertions.assertTrue(Math.abs(Math.cos(Math.toRadians(90)) - TeylorRow.calcCos(16, Math.toRadians(90))) < Math.pow(10, -14));
        Assertions.assertTrue(Math.abs(Math.cos(Math.toRadians(180)) - TeylorRow.calcCos(16, Math.toRadians(180))) < Math.pow(10, -14));
        Assertions.assertTrue(Math.abs(Math.cos(Math.toRadians(270)) - TeylorRow.calcCos(16, Math.toRadians(270))) < Math.pow(10, -14));
        Assertions.assertTrue(Math.abs(Math.cos(Math.toRadians(360)) - TeylorRow.calcCos(16, Math.toRadians(360))) < Math.pow(10, -14));
        Assertions.assertTrue(Math.abs(Math.cos(Math.toRadians(30)) - TeylorRow.calcCos(16, Math.toRadians(30))) < Math.pow(10, -14));
        Assertions.assertTrue(Math.abs(Math.cos(Math.toRadians(45)) - TeylorRow.calcCos(16, Math.toRadians(45))) < Math.pow(10, -14));
    }
}